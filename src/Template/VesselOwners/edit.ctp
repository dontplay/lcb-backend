<div class="actions columns large-2 medium-3">
	<h3><?= __('Actions') ?></h3>
	<ul class="side-nav">
		<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $vesselOwner->id], ['confirm' => __('Are you sure you want to delete # {0}?', $vesselOwner->id)]) ?></li>
...
<?= $this->Form->create($vesselOwner) ?>
	<fieldset>
		<legend><?= __('Edit Vessel Owner') ?></legend>
	<?php
