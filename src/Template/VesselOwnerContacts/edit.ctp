<div class="actions columns large-2 medium-3">
	<h3><?= __('Actions') ?></h3>
	<ul class="side-nav">
		<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $vesselOwnerContact->id], ['confirm' => __('Are you sure you want to delete # {0}?', $vesselOwnerContact->id)]) ?></li>
...
<div class="vesselOwnerContacts form large-10 medium-9 columns">
<?= $this->Form->create($vesselOwnerContact) ?>
	<fieldset>
		<legend><?= __('Edit Vessel Owner Contact') ?></legend>
	<?php
