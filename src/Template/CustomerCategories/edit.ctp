<div class="actions columns large-2 medium-3">
	<h3><?= __('Actions') ?></h3>
	<ul class="side-nav">
		<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $customerCategory->id], ['confirm' => __('Are you sure you want to delete # {0}?', $customerCategory->id)]) ?></li>
...
<div class="customerCategories form large-10 medium-9 columns">
<?= $this->Form->create($customerCategory) ?>
	<fieldset>
		<legend><?= __('Edit Customer Category') ?></legend>
	<?php
