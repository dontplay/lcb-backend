...
/**
 * ShipmentTypesFixture
 *
 */
class ShipmentTypesFixture extends TestFixture {
 ...
 */
	public $fields = [
		...
		'_constraints' => [
			...
			'created_id' => ['type' => 'unique', 'columns' => ['creator_id'], 'length' => []],
			'modified_id' => ['type' => 'unique', 'columns' => ['modifier_id'], 'length' => []],
		],
		'_options' => [
 ...
 */
	public $records = [
		[
			...
			'recstatus' => 1,
			'creator_id' => 1,
			'created' => '2014-11-24 18:50:13',
			'modifier_id' => 1,
			'modified' => '2014-11-24 18:50:13',
