...
/**
 * PortAgentContactsFixture
 *
 */
class PortAgentContactsFixture extends TestFixture {
 ...
 */
	public $fields = [
		...
		'port_agent_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
		...
		'_constraints' => [
			...
			'port_agent_id' => ['type' => 'unique', 'columns' => ['port_agent_id'], 'length' => []],
		],
		'_options' => [
 ...
 */
	public $records = [
		[
			...
			'recstatus' => 1,
			'creator_id' => 1,
			'created' => '2014-11-24 19:35:32',
			'modifier_id' => 1,
			'modified' => '2014-11-24 19:35:32',
			'port_agent_id' => 1,
